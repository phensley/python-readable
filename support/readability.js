...
var dbg = (typeof console !== 'undefined') ?
function(s) {
    ...
    **/
    addFootnotes: function(articleContent) {
        ...
        if (!footnotesWrapper) {
            ...
            /* Until we know we have footnotes, don't show the references block. */
    ...
    **/
    grabArticle: function(page) {
        ...
        **/
        ...
        var nodesToScore = [];
        for (var nodeIndex = 0;
        (node = allElements[nodeIndex]); nodeIndex += 1) {
